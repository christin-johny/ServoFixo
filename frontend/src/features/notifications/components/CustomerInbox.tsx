...
import { useCustomerNotifications } from '../../notifications/hooks/useCustomerNotifications';
import { formatDistanceToNow } from 'date-fns';

interface Props { onClose: () => void; }

const CustomerNotificationInbox: React.FC<Props> = ({ onClose }) => {
    ...
    <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden ring-1 ring-black/5 animate-fade-in">
      ...
      <div className="max-h-[400px] overflow-y-auto custom-scrollbar">
        {loading && displayedNotifications.length === 0 ? (
          <div className="p-12 text-center text-gray-400 text-sm italic">Loading updates...</div>
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 text-xs font-semibold">
              {activeTab === 'unread' ? 'You are all caught up!' : 'No notifications yet'}
            </p>
          </div>
        ) : (
...
export default CustomerNotificationInbox;