...
import type { AdminTechnicianProfileDto } from "../../../profile/types/TechnicianVerificationDtos";
import type { ServiceRequest, ZoneRequest, BankUpdateRequest } from "../../types/TechnicianRequestTypes";
