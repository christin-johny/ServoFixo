...
import { ArrowRight, ArrowLeft, Loader2, Calculator, CheckCircle2, AlertCircle } from "lucide-react";
...
const Step4_Rates: React.FC<Step4Props> = ({ onNext, onBack }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50 text-gray-600 font-bold border-b border-gray-100">
              <tr>
                ...
                {/* Removed duplicate/confusing 'Base Price' column */}
      ...
      <div className="flex justify-between pt-6 border-t border-gray-100">
        ...
        <button
          onClick={handleNext}
          disabled={isSaving || !isAgreed || rateCard.length === 0}
