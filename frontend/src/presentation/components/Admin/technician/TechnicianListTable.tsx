...
import { Shield, Ban, Eye, Edit2, Clock, ShieldCheck, AlertCircle } from 'lucide-react';
            ...
            {technicians.map((tech) => (
                ...
                <td className="py-4 px-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">ID: {tech.id.slice(-6)}</p>
                    </div>
                    </div>
                </td>
                <td className="py-4 px-6">
                ...
                <td className="py-4 px-6 text-right">
                    ...
                    {/* ✅ FIX: Navigate to the Profile Page route, NOT verification */}
                    <button 
                    ...
                    <button 
                        ...
                        className={`p-2 rounded-lg transition-colors ${tech.isSuspended ? 'bg-green-50 text-green-600 hover:bg-green-100' : 'bg-red-50 text-red-600 hover:bg-red-100'}`}
