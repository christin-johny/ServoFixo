export const LogEvents = {
  ...
  AUTH_REGISTER_FAILED_EMAIL_EXISTS:
    "Registration Failed - Email Already Exists",
  AUTH_REGISTER_FAILED_PHONE_EXISTS:
  ...
  ADMIN_CUSTOMER_ADDRESS_FETCH_INIT:
    "Admin: Fetch Customer Addresses Initiated",
  ...
  //Booking
  BOOKING_CREATION_INIT: "BOOKING_CREATION_INIT",
  BOOKING_CREATION_SUCCESS: "BOOKING_CREATION_SUCCESS",
  BOOKING_CREATION_FAILED: "BOOKING_CREATION_FAILED",
  
  BOOKING_ASSIGNMENT_INIT: "BOOKING_ASSIGNMENT_INIT",
  BOOKING_STATUS_UPDATE: "BOOKING_STATUS_UPDATE",
  
  START_JOB_FAILED: "START_JOB_FAILED",
  BOOKING_RESPONSE_FAILED: "BOOKING_RESPONSE_FAILED",
  GET_CUSTOMER_BOOKINGS_FAILED: "GET_CUSTOMER_BOOKINGS_FAILED",
  JOB_STATUS_UPDATE_FAILED: "JOB_STATUS_UPDATE_FAILED",
  ADD_EXTRA_CHARGE_FAILED: "ADD_EXTRA_CHARGE_FAILED",
  RESPOND_EXTRA_CHARGE_FAILED: "RESPOND_EXTRA_CHARGE_FAILED",
  GET_TECH_HISTORY_FAILED: "GET_TECH_HISTORY_FAILED",
  JOB_COMPLETION_FAILED: "JOB_COMPLETION_FAILED",
  ...
  ADMIN_FORCE_ASSIGN_FAILED: "ADMIN_FORCE_ASSIGN_FAILED",
  ADMIN_FORCE_STATUS_FAILED: "ADMIN_FORCE_STATUS_FAILED",
  ADMIN_UPDATE_PAYMENT_FAILED: "ADMIN_UPDATE_PAYMENT_FAILED",
  ADMIN_GET_ALL_FAILED: "ADMIN_GET_ALL_FAILED",
  EXTRA_CHARGE_ADDED_LOG: "Extra charge added to booking",
  BOOKING_CREATED_LOG: "Booking created", 
  BOOKING_CANCELLED_BY_CUSTOMER : "Booking cancelled by customer",
  BOOKING_LATE_RESPONSE: "Late response attempt for booking",
  BOOKING_ACCEPTED_LOG: "Booking ACCEPTED",
  BOOKING_REJECTED_LOG: "Booking REJECTED",
  BOOKING_FAILED_NO_CANDIDATES: "Booking FAILED. Candidates exhausted.",
  CHARGE_RESPONSE_LOG : "Charge response recorded",

  TECH_CANCEL_INIT: "Tech cancelling active booking",
  TECH_CANCEL_REJECT_FAILED: "Cancel Reject failed, status mismatch",
  TECH_CANCEL_REASSIGNED: "Booking re-assigned to next candidate",
  TECH_CANCEL_NO_CANDIDATES: "No candidates left for booking",
